                ...
                self.viewModel.uploadImages(
                    ...
                    completion: { [weak self] result in
                        ...
                        case .success(let response):
                            ...
                            LocalStorageManager.shared.saveSelectedImageVisitData(model: self.viewModel.selectedImages)
            ...
            .bind(to: collectionViewImages.rx.items(
                ...
                cell.deleteImage = { [weak self] in
                    ...
                    if let index = currentImages.firstIndex(where: { $0.id == model.id }) {
                        ...
                        LocalStorageManager.shared.saveSelectedImageVisitData(model: currentImages)
